...
# end
# NEVER USED
# Actor.create(first_name: "Robin", last_name: "Wright", age: 54, gender: "Female", known_for: "The Princess Bride")
# Actor.create(first_name: "Cary", last_name: "Elwys", age: 58, gender: "Male", known_for: "The Princess Bride")
# Actor.create(first_name: "Leonardo", last_name: "DiCaprio", age: 46, gender: "Male", known_for: "Titanic")
